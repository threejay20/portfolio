    ...
    >
      ...
      items-center max-w-7x1 mx-auto">
        ...
        >
          ...
          <p className="text-white text-[18px]font-bold cursor-pointer flex">Justin Johnson &nbsp; <span className="sm:block hidden"></span></p>
        ...
        <ul className="list-none hidden sm:flex flex-row gap-10">
          {navLinks.map((link) => (
            ...
            className={`${
              ...
              ? "text-white"
              : "text-secondary"
            } hover:text-white text-[18px] font-medium cursor-poiinter`}
